...
struct Recipe: Identifiable {
    ...
    var mainInformation: MainInformation // Contains the primary information of the recipe
    var ingredients: [Ingredient] // List of ingredients
    var directions: [Direction] // List of cooking directions
    var isFavorite = false // Favorite status flag
    ...
    // Validation check to ensure that the recipe has valid main information, ingredients, and directions
    var isValid: Bool {
        mainInformation.isValid && !ingredients.isEmpty && !directions.isEmpty
    }
    
    // Function to find the index of a specific direction
...
// Main Information Structure for the Recipe
struct MainInformation {
    var name: String // Name of the recipe
    var description: String // Description of the recipe
    var author: String // Author of the recipe
    var category: Category // Category (breakfast, lunch, etc.)
    ...
    // Validation check for name, description, and author
    var isValid: Bool {
        !name.isEmpty && !description.isEmpty && !author.isEmpty
    }
}

// Direction Structure representing a cooking step
struct Direction: RecipeComponent {
    var description: String // Description of the step
    var isOptional: Bool // Whether the step is optional
    
    // Custom and default initializers
...
// Ingredient Structure representing an ingredient
struct Ingredient: RecipeComponent {
    var name: String // Name of the ingredient
    var quantity: Double // Quantity required
    var unit: Unit // Unit of measurement
    ...
    // Description for displaying the ingredient
    ...
    enum Unit: String, CaseIterable {
        ...
        // Property to get the singular name of the unit
